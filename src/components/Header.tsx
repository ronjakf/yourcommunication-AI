    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`flex justify-between items-center px-6 py-4 rounded-2xl transition-all duration-500 ${
          isScrolled ? 'glass shadow-2xl shadow-indigo-500/5' : 'bg-transparent'
        }`}>
          <div className="flex-shrink-0 flex items-center">
            <a href="#" className="font-display font-bold text-2xl tracking-tighter text-white">
              (you)<span className="text-indigo-400">r</span><span className="text-zinc-500 font-medium ml-2 text-xl">communication</span>
            </a>
          </div>
          ...
          <div className="hidden md:flex">
            <a
              ...
              className="relative inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-white transition-all duration-300 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:border-white/20 hover:shadow-[0_0_20px_rgba(79,70,229,0.3)] overflow-hidden group"
            >
        ...
        {isMenuOpen && (
          ...
          >
            <div className="glass rounded-2xl p-4 shadow-2xl flex flex-col space-y-2">
              ...
              <a
                href="mailto:yourcommunication@gmail.com"
                className="block text-center mt-4 px-4 py-3 text-base font-medium text-white bg-indigo-600 hover:bg-indigo-500 rounded-xl transition-colors"
                onClick={() => setIsMenuOpen(false)}
              >
                Anfrage senden
              </a>
